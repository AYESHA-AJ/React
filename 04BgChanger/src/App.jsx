...
function App() {
  ...
  //function onClick requires a function not what the function returns,if we use directly setColor("") we are executing the function directly we dont need this and simply setColor cant be called because we need to pass parameter
  return (
